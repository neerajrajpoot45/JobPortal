...
const JobDescription = () => {
    ...
    useEffect(()=>{
        ...
        console.log('singleJob state updated:', singleJob);
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
            <h1 className='font-bold my-1'>Role: <span className='pl-4 font-normal text-gray-800'>{singleJob?.title ? singleJob.title : 'Loading...'}</span></h1>
